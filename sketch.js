...
function preload(){
  backgroundImg = loadImage('others/bg.jpg');
  birdImg = loadAnimation('bird/1.png','bird/2.png','bird/3.png','bird/4.png');
  enemyImg = loadAnimation('enemy/4.png','enemy/5.png','enemy/6.png','enemy/7.png','enemy/8.png','enemy/9.png',);
  grassImg = loadImage('others/1617523698490.png')
  stoneImg = loadImage('others/1617523632733.png')
  bulletimg = loadImage('others/1617519529904.png')
  boardimg = loadImage('others/1617528339326.png')
  diamondImg= loadImage('others/1617528531157.png')
  lifeimg= loadImage('others/1617697386447.png')
}
